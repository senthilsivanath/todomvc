...
class AResourceIT {
    ...
    public static A createEntity(EntityManager em) {
        A a = new A().name(DEFAULT_NAME).age(DEFAULT_AGE);
        return a;
    }
    ...
    public static A createUpdatedEntity(EntityManager em) {
        A a = new A().name(UPDATED_NAME).age(UPDATED_AGE);
        return a;
    }
    ...
    void putNewA() throws Exception {
        ...
        em.detach(updatedA);
        updatedA.name(UPDATED_NAME).age(UPDATED_AGE);
    ...
    void fullUpdateAWithPatch() throws Exception {
        ...
        partialUpdatedA.name(UPDATED_NAME).age(UPDATED_AGE);
